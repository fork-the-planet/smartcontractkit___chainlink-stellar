...
// StellarAdapter provides Stellar-specific address encoding utilities.
type StellarAdapter struct{}

// NewChainFamilyAdapter creates a new Stellar chain family adapter.
func NewChainFamilyAdapter() *StellarAdapter {
	return &StellarAdapter{}
}

// AddressRefToBytes decodes a strkey-encoded Stellar address (C... for contracts, G... for accounts)
