...
fn setup_env() -> (
    ...
    pool_client.initialize(&owner, &token_address, &7u32, &router_client.address);
...
fn test_initialize_rejects_decimals_above_uint8() {
    ...
    let r = pool_client.try_initialize(&owner, &token_address, &256u32, &router_client.address);
