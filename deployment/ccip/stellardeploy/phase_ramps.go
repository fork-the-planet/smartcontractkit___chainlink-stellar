...
func (w *deployRun) deployRampsAndProvisionalLanes() error {
	...
	if _, err := execStellarOp(w, rrops.ApplyRampUpdates, rrops.ApplyRampUpdatesInput{
		ContractID:     rampRegistryContractID,
		OnRampUpdates:  rrOnRamp,
		OffRampRemoves: []rampregistrybindings.OffRampEntry{},
		OffRampAdds:    rrOffRamp,
	}); err != nil {
